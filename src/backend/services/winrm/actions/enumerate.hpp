...
namespace tao::json {
    ...
    struct traits<trustwave::winrm_action_enumerate_msg>
            : binding::object<binding::inherit<traits<trustwave::action_msg> >,
                    TAO_JSON_BIND_REQUIRED("key", &trustwave::winrm_action_enumerate_msg::key_) > {
...
namespace trustwave {
    ...
    public:
        Winrm_Enumerate_Action() :
                Action_Base( trustwave::winrm_action_enumerate_msg::act_name)
        {
        }
